...
/// PATCHED -- remove BXCAN_BUSYWAIT_DELAY_SYSTEM_CORE_CLOCK config.
                                      ...
                                      const bool                      target_state)
{
    ...
    for (uint16_t wait_ack = 0; wait_ack < TimeoutMilliseconds; wait_ack++)
    {
        ...
        // PATCHED -- replace busywait with sleep.
               ...
               const void* const payload)
{
    ...
    // Therefore it is safe to enqueue the frame now if there is a free mailbox.
