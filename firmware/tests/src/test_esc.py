...
class TestESC:
    ...
    async def test_rpm_run_2_sec(prepared_double_redundant_node):
        ...
        for index, node_info in enumerate(node_info_list):
            ...
            configure_registers(registry, tester_node, node_info)
        ...
        try:
            for i in range(40000):
                rpm_message = reg.udral.service.actuator.common.sp.Vector8_0(value=[rpm_to_radians_per_second(200),
                                                                                    rpm_to_radians_per_second(200)])
