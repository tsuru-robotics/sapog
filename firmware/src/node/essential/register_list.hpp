...
std::string_view all_register_names[] = {
  ...
  "uavcan.pub.esc_feedback.id", "uavcan.pub.esc_feedback.type",
  "uavcan.pub.esc_power.id", "uavcan.pub.esc_power.type",
  "uavcan.pub.esc_dynamics.id", "uavcan.pub.esc_dynamics.type",
